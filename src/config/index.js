...
export const animalsMapping = {
  Cheetah: {
    desc1: `You paid great attention to your individual feeling and like
    pursuing the latest trend.<br/>As a long-term investor, you distinguish trends from fads.`,
    desc2: `
      You are a Insightful NFT Buyer!
    `,
  },
  Rabbit: {
    desc1: `You are a freshman in the Web3 world. <br/>
    Everything here is thrilling but unfamiliar to you. <br/>
    Keep learning. Keep exploring. Don't be fueled by the noisy voice.`,
    desc2: `You are a Crypto Newbie!`,
  },
  Unicorn: {
    desc1: `Web3 world is like a beautiful but challenging jungle.<br/>
    Have your own pace and find out the useful tools to grow up.<br/>
  ...
  Panda: {
    ...
    It is cool to keep up with the trendy DAO group and voice your mind.<br/>
  ...
  Elephant: {
    ...
    Lots of fun and gains you have achieved from the trend of the NFT space.`,
  ...
  Tiger: {
    ...
    The complex gaming mechanism is piece of cake to you.<br/>
    Gear up and ready for the next amazing innovation of X to Earn.`,
    desc2: `You are an Experienced X to Earn Player!`,
  },
  Monkey: {
    desc1: `You are aware of the trend of Layer2 and engage in.<br/>
    Your long-term contribution may blossom up one day.`,
